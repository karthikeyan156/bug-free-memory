...
with tab2:
        ...
        if uploaded_file is not None:
            ...
            if scrape_skill and scrape_location:
                with st.spinner("Scraping job data..."):
                    ...
                    coursera_url2 = f"https://www.coursera.org/search?query={urllib.parse.quote_plus(missing_keywords[1])}"
                    udemy_url2 = f"https://www.udemy.com/courses/search/?src=ukw&q={urllib.parse.quote_plus(missing_keywords[1])}"
    ...
    # Button for job scraping
    #scrape_submit = st.button("Scrape Jobs")
